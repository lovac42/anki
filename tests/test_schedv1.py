...
def test_cram():
    ...
    assert d.decks.all(sort=True)[0].newCount() == 1
...
def test_deckDue():
    ...
    def l(i):
        d = cnts[i]
        return [d.getName(), d.getId(), d.revCountSingle(), d.lrnCountSingle(), d.newCountSingle()]
