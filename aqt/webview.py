...
class AnkiWebPage(QWebEnginePage):
    ...
    @staticmethod
    def javaScriptConsoleMessage(lvl, msg, line, srcID):
        # not translated because console usually not visible,
        # and may only accept ascii text
        buf = "JS error on line %(line)d: %(msg)s" % dict(line=line, msg=msg+"\n")
    ...
    @staticmethod
    def acceptNavigationRequest(url, navType, isMainFrame):
        if not isMainFrame:
            return True
...
class AnkiWebView(QWebEngineView):
    ...
    def contextMenuEvent(self, evt):
        ...
        runHook("AnkiWebView.contextMenuEvent", self, menu)
